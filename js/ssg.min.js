...
// Qui puoi tradurre SSG in altre lingue. Lascia i tag <> e "" così come sono.
SSG.cfg.hint1 = "Naviga nella Story Show Gallery con:";
SSG.cfg.hint2 = "la rotella del mouse <strong>⊚</strong> o i tasti freccia <strong>↓→↑←</strong>";
SSG.cfg.hint3 = "o <strong>TAPPA</strong> in basso (o in alto) sullo schermo";
SSG.cfg.hintTouch = "<strong>Scorri</strong> a sinistra (o a destra) o<br><strong>Tappa</strong> in basso (o in alto) sullo schermo<br> per navigare nella <i>Story Show Gallery</i>.";
SSG.cfg.hintFS = 'Per una migliore esperienza <br><a><abbr>⎚</abbr> vai a schermo intero</a>';
SSG.cfg.toTheTop = "Torna all'inizio";
SSG.cfg.exitLink = "Esci dalla Galleria";

// finestra di dialogo per la condivisione del link
SSG.cfg.imageLink = "Il link all'immagine selezionata:";
SSG.cfg.copyButton  = "⎘ Copia il link negli appunti";
SSG.cfg.linkPaste = "…e puoi incollarlo ovunque tramite ctrl+v";

// in modalità verticale la galleria suggerisce di ruotare il telefono in modalità orizzontale
SSG.cfg.showLandscapeHint = true; // Questo è un valore booleano, non necessita di traduzione del valore stesso
SSG.cfg.landscapeHint = '<i>↻</i> le foto si vedono meglio in modalità orizzontale <span>📱</span>';
...
SSG.initGallery = function ( event ) {
    ...
    jQuery( 'body' ).append( "<div id='SSG_bg'><span><img src='img/icon_ai.png' alt='Icona AI' style='width: 1.2em; height: 1.2em; vertical-align: middle; filter: invert(100%);'> Scopri le varie Gallerie</span></div>" );
...
SSG.shareMenu = function(newOne, caption) {
    ...
    var shareMenu = "<span class='SSG_share' " + (SSG.cfgFused.imgBorderRadius > 6 ? ("style='bottom:"+ (SSG.cfgFused.imgBorderRadius-1) + SSG.radiusUnit + "'") : "")  + "><span class='SSG_share-menu'>" +
                "<a class='instagram' " + windowOpen + "https://www.instagram.com/share?url=" + urlToShareEnc + WindoOpenParams + " title='Share on Instagram'></a>" + 
                ...
                "<a class='tweet' " + windowOpen + "http://x.com/share?text=" + textToShareEnc + "&url=" + urlToShareEnc + WindoOpenParams + " title='Share on X'></a>" + 
...
SSG.destroyGallery = function (mode) {
    ...
    jQuery( document ).off( 'webkitfullscreenchange mozfullscreenchange fullscreenchange', SSG.onFS ); // Era un duplicato mozfullscreenchange, ho semplificato
    ...
    // Qui devi aggiungere #SSGsharpen nel selettore .remove()
    jQuery( '#SSG_bg, #SSG1, #SSG_exit, #SSG_lastone, #SSG_tip, svg:has(#SSGsharpen)' ).remove();    
    // E aggiungi queste due righe per ripristinare correttamente l'overflow del body e dell'HTML
